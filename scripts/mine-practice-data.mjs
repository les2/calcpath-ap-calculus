...
const sourceRecords = [
  ...
  ,{ id: 'openstax-calculus-volume-3', title: 'OpenStax Calculus Volume 3', author: 'OpenStax', url: 'https://openstax.org/details/books/calculus-volume-3', attribution: 'Transcribed from OpenStax Calculus Volume 3; each question records its exact pinned exercise and publisher solution.', license: { code: 'CC-BY-NC-SA-4.0', name: 'CC BY-NC-SA 4.0', url: 'https://creativecommons.org/licenses/by-nc-sa/4.0/', usage: 'embedded' } }
];
